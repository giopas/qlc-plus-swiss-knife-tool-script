...
- **Quick Start — PANIC RESET**: every generated workspace has a *PANIC RESET* scene (all fixtures neutral: shutter open, no effects, Pan/Tilt centred, intensity 0) on its own VC button next to *PANIC / BLACKOUT*. Clears Doctor D008.
