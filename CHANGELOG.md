...
- **Quick Start MASTER slider held every dimmer at full.** It was a *Level* slider on the dimmer channels, so at 255 it kept intensity up (HTP) through BLACKOUT and PANIC RESET. It is now a *Submaster*, as in the 20Minutes shows: it scales the looks, it never sets a channel.
